...
export function dummyData(): IAssignment[] {
    return [
        {
          "id": 1,
          "title": "Binärer Suchbaum - Zahlen hinzufügen",
          "text": "Fügen Sie die Zahlen 4, 18, 32 und 47 in die Ausgangssituation des binären Suchbaums ein. Erstellen Sie den Zustand des Suchbaums,\nnachdem sie die Zahlen in der angegebenen Reihenfolge eingefügt haben.",
          "stepsEnabled": false,
          "dataStructure": "tree",
        ...
        {
          "id": 2,
          "title": "Binärer Suchbaum - Zahlen löschen",
          "text": "Löschen Sie die Zahl 19 aus der gegebenen Ausgangssituation des binären Suchbaums heraus. Erstellen Sie den Zustand des Suchbaums, nachdem Sie die Zahl gelöscht haben. (eine Variante genügt!)",
          "stepsEnabled": false,
          "dataStructure": "tree",
          "binarySearchTreeConfiguration": {
            "initialRootNode": {
